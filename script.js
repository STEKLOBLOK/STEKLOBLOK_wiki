    ...
    articles: [
        ...
        // ПРЕДМЕТЫ
        {
            ...
            fullDesc: `
                ...
                <p>В комплекте присутствует гофротруба резинотканевая. Это необходимо из-за большого веса ФПК, около 900 грамм. ФПК размещается в сумке типа "Е". Данная сумка характеризуется наличием кармана для ФПК.</p>
        ...
        // ПРОТИВОГАЗЫ
        {
            ...
            fullDesc: `
                ...
                <h2>📃 Научная база</h2>
                <p>Статья из журнала "Вестник ТГТУ" - https://vestnik.tstu.ru/rus/t_14/pdf/14_1_011.pdf</p>
            `,
            gallery: [
