...
Внутри деревянного сруба башни находится независимый железобетонный каркас, поддерживающий водяной бак.</p>
        ...
        // ПРОТИВОГАЗЫ
        {
            ...
            fullDesc: `
                <h2>📜 История</h2>
                <p>Изолирующий противогаз, тип 46 — это изолирующий (регенеративный) противогаз, предназначенный для защиты органов дыхания, глаз и кожи лица в атмосфере с недостатком кислорода или содержащей любые вредные примеси в высоких концентрациях. Противогаз ИП-46 был снят с вооружения ВМФ СССР в 1978 году.</p>
