...
Внутри деревянного сруба башни находится независимый железобетонный каркас, поддерживающий водяной бак.</p>
        ...
        },
        {
            ...
            fullDesc: `
                <h2>📜 История</h2>
                <p>Гражданский противогаз, тип 5 — это классический фильтрующий противогаз времён холодной войны, предназначенный для защиты органов дыхания, глаз и кожи лица от отравляющих веществ, радиоактивной пыли и бактериальных аэрозолей. Производился до 1990х годов. Всего было выпущено более 900 млн штук, т.к. на каждого гражданина СССР должно было хватать по три противогаза.</p>
                
                <h2>🛠 Конструкция</h2>
                <p>В состав противогаза входят лицевая часть ШМ-62 или ШМ-62у, сумка, незапотевающие плёнки (НП), инструкция, фильтрующе-поглощающая коробка (ФПК). ШМ-62у отличается от ШМ-62 толщиной резины. Маска выпускалась в пяти размерах: 0, 1, 2, 3, 4. Так же имеется вариант из чёрной резины - ШМП (шлем-маска специальная). Маска имеет очковый узел из двух линз в металлических ободах. Клапанная коробка снабжена стандартной резьбой 40х4 мм, что позволяет использовать любой стандартный фильтр. От клапана вдоха воздух проходит по резиновым трубкам к очкам, что предотвращает их запотевание. Очки имеют крепление для НП.</p>
