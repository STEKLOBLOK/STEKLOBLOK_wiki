...
const database = {
    ...
    articles: [
        ...
        {
            id: 'p5',
            title: 'Гражданский противогаз ГП-5',
            category: 'gasmasks',
            image: 'gp5mask.jpg',
            address: 'Музейная коллекция',
            state: '1981 г.',
            ...
            fullDesc: `
                ...
                <h2>⚠️ Важно</h2>
                <p>ФПК ГП-5 не защищает от аммиака и угарного газа (необходимо использовать ДПГ-3 или ДП-2 соответственно).</p>
