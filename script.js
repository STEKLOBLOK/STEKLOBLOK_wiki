...
Внутри деревянного сруба башни находится независимый железобетонный каркас, поддерживающий водяной бак.</p>
        ...
        // ПРОТИВОГАЗЫ
        {
            ...
            fullDesc: `
                <h2>📜 История</h2>
                <p>Изолирующий Дыхательный Аппарат изолирующий противогаз, тип 46 — это изолирующий (регенеративный) противогаз, так же известен как ЕО-31, предназначенный для защиты органов дыхания, глаз и кожи лица в атмосфере с недостатком кислорода или содержащей любые вредные примеси в высоких концентрациях. Производился с 1950х годов.</p>
